...
import { FaUsers, FaRegLightbulb } from 'react-icons/fa'; // Icônes modernisées

const Hero: React.FC = () => {
    return (
        <div className="flex flex-col items-center justify-center h-[60vh] bg-gradient-to-b from-[#e0dbd4] to-[#ffffff] p-4">
            <h1 className="text-4xl md:text-6xl font-bold mb-8 text-center text-[#333] transition transform duration-500 hover:scale-105">
                In verbinding met jezelf, <br />in verbinding met je gezin
            </h1>
