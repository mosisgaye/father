...
export default function Hero() {
  return (
    <section
      ...
      style={{
        background: "linear-gradient(to bottom, #F5DEB3 40%, #F5F5DC 60%)",
      }}
    >
      <div className="relative flex flex-col md:flex-row items-center max-w-6xl mx-auto">
        <div className="relative">
          {/* Large Rectangular Image */}
          <div className="overflow-hidden border-4 border-[#0065de] rounded-xl">
            <Image
        ...
        <div className="mt-8 md:mt-0 md:ml-20 text-center md:text-left px-6">
          <h1 className="text-[#0065de] text-3xl md:text-5xl mb-2 font-bold uppercase tracking-wide">
          ...
          <h2 className="text-[#b5885c] text-xl md:text-3xl mb-6 md:mb-10 font-semibold leading-relaxed uppercase">
